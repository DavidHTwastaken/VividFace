...
class TemporalAutoencoderKL(ModelMixin, ConfigMixin, FromOriginalModelMixin):
    ...
    def __init__(
        ...
        self.post_temporal_quant_conv = CausalConv3d(latent_channels, latent_channels, 1)

        self.temporal_decoder = TemporalDecoder(
            in_out_channels=latent_channels,
            latent_embed_dim=latent_channels,
    ...
    def _decode(self, z: torch.Tensor, return_dict: bool = True) -> Union[DecoderOutput, torch.Tensor]:
        ...
        z = self.post_temporal_quant_conv(z)
